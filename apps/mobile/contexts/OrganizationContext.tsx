...
type OrganizationContextType = {
  ...
  /** Valor persistido em users.current_organization_id (pode ser null). */
  storedOrganizationId: string | null
  /** Org da turma atual (users.current_class_id → classes.organization_id), se houver. */
  currentClassOrganizationId: string | null
  /** Org efetiva para ClassContext e navegação (resolve membership + stored + turma). */
