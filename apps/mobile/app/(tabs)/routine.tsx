...
import { ArrowRight, Moon, CalendarDays, Settings2, Clock, ChevronRight } from 'lucide-react-native'
import { useUser } from '@/hooks/useUser'
import { useProgress, type AreaStat } from '@/hooks/useProgress'
            ...
            <View key={dia.idx} style={{ flex: 1, alignItems: 'center' }}>
              ...
              <View
                style={{
                  ...
                  height: 5,
                  borderRadius: 2.5,
                  backgroundColor: dia.ehPassado ? `${dotColor}50` : isToday ? '#fff' : dotColor,
                }}
              />
            </View>
          )
              ...
              >
                {proximosDias.map((dia, i) => (
                  <StaggerItem key={dia.idx} index={i} baseDelay={300} stagger={50}>
                    <LinhaProximoDia dia={dia} isLast={i === proximosDias.length - 1} />
                  </StaggerItem>
                ))}
              </View>
            </FadeInSection>
            ...
            <FadeInSection delay={400}>
              ...
              >
                ...
                >
                  ...
                  {/* Content */}
                  <View
                    style={{ marginTop: 16, flexDirection: 'row', alignItems: 'baseline', gap: 6 }}
                  >
                    <Text
                      style={{
                        fontSize: 28,
                  ...
                  >
                    <Text
                      style={{ fontSize: 10, fontFamily: fonts.sans, color: colors.text.muted }}
                    >
                      Seg
                    </Text>
                    <Text
