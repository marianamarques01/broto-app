                  ...
                  >
                    <View
                      style={{
                        ...
                        borderRadius: 12,
                        backgroundColor: isSelected ? colors.green.glow : 'transparent',
                        borderWidth: 1,
                        borderColor: isSelected ? colors.green[500] : 'transparent',
                      }}
                    >
                      <Text
                        style={{
                          ...
                          color: isSelected ? colors.green[400] : colors.text.primary,
                        }}
                      >
                        {item.label}
                      </Text>
...
export default function EnemQuestionsScreen() {
  ...
  if (activeQuestion) {
    return (
      <SafeAreaView
        className="flex-1"
        style={{ backgroundColor: '#02140D', position: 'relative', overflow: 'hidden' }}
        edges={['top']}
      >
        <FireflyBackground count={7} runKey={animKey} opacity={0.9} />
        <View
        ...
        >
          <QuestionPlayer
            ...
            onNext={questionIdx < questions.length - 1 ? handleNext : undefined}
          />
        </ScrollView>
      </SafeAreaView>
    )
          ...
          <FadeInSection delay={0}>
            ...
            >
              <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                <AlertCircle size={18} color={colors.red[500]} />
                <Text
                  style={{ fontSize: 13, fontFamily: fonts.sans, color: colors.red[400], flex: 1 }}
                >
                  {error}
                </Text>
              </View>
            ...
            <FadeInSection delay={160}>
              ...
              <View style={{ marginBottom: 14 }}>
                <Text style={{ fontSize: 13, fontFamily: fonts.sans, color: colors.text.muted }}>
                  <Text style={{ fontFamily: fonts.sansBold, color: colors.text.secondary }}>
                    {questions.length}
                  </Text>{' '}
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <Text
                              style={{ fontSize: 13, fontFamily: fonts.sansBold, color: acColor }}
                            >
                              {idx + 1}
                            </Text>
                          </View>
