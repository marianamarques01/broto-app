...
function resolveSvgImport(m: unknown): ComponentType<SvgProps> | null {
    ...
    if (m && typeof m === 'object' && 'default' in m && typeof (m as { default: unknown }).default === 'function') {
...
export function BrotoLogo({ size = 'header' }: { size?: Size }) {
    ...
    return (
        <View style={{ justifyContent: 'center' }} accessible accessibilityRole="image" accessibilityLabel="Broto">
