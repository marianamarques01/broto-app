    ...
    return (
        ...
        >
            <Svg width={size} height={size} style={StyleSheet.absoluteFill}>
                ...
                <Circle cx={size / 2} cy={size / 2} r={size / 2} fill={subtle ? 'url(#centralGlowSub)' : 'url(#centralGlow)'} />
            </Svg>
        </View>
    );
}
        ...
        >
            <Svg width={w} height={h} style={StyleSheet.absoluteFill}>
                <Defs>
                    ...
                    <RadialGradient id="glowGreen" cx="0.15" cy="0.45" rx="0.8" ry="0.5" gradientUnits="objectBoundingBox">
                    ...
                    <RadialGradient id="glowGold" cx="0.8" cy="0.2" rx="0.6" ry="0.7" gradientUnits="objectBoundingBox">
                        <Stop offset="0%" stopColor={colors.gold[400]} stopOpacity="0.2" />
                        <Stop offset="60%" stopColor={colors.gold[400]} stopOpacity="0" />
                    </RadialGradient>
                    {/* Verde baixo — 50% 85% */}
                    <RadialGradient id="glowGreenBottom" cx="0.5" cy="0.85" rx="0.9" ry="0.5" gradientUnits="objectBoundingBox">
