...
export function OptionButton({ letter, text, state, answered, onPress }: OptionButtonProps) {
  return (
    <Pressable
      onPress={onPress}
      disabled={answered}
    ...
    >
      ...
      {text && (
        <Text className="flex-1 pt-0.5 text-sm leading-relaxed" style={{ color: textColor[state] }}>
          {text}
        </Text>
      )}
    </Pressable>
