...
import { useBrotoChat } from '@/hooks/useBrotoChat'
import { BrotoChatUnavailableState } from '@/components/broto/BrotoChat'
...
type BrotoChatModalSessionProps = {
  onClose: () => void
  onOpenFullPage: () => void
}

function BrotoChatModalSession({ onClose, onOpenFullPage }: BrotoChatModalSessionProps) {
  ...
  return (
    <>
      ...
      <div className="broto-chat-modal__body">
        {isWelcomeOnly && !loading && !historyLoading ? (
      ...
      <div className="broto-chat-modal__composer-wrap">
        <form className="broto-chat-modal__composer" onSubmit={handleSubmit}>
          ...
          <div className="broto-chat-modal__composer-footer">
            <button
              type="submit"
              className={`broto-chat-modal__send ${input.trim() && !loading && !historyLoading ? 'broto-chat-modal__send--active' : ''}`}
