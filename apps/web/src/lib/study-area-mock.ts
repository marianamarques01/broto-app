...
export const MOCK_TOPICS: Record<string, TopicOption[]> = {
  linguagens: [
    { value: 'interpretacao-texto', label: 'Interpretação de Texto', accuracy: 72, totalAnswered: 18 },
    ...
    { value: 'variacoes-linguisticas', label: 'Variações Linguísticas', accuracy: null, totalAnswered: 0 },
  ],
  'ciencias-humanas': [
  ...
  matematica: [
    ...
    { value: 'probabilidade', label: 'Probabilidade e Estatística', accuracy: 70, totalAnswered: 10 },
...
As questões de Genética no ENEM geralmente cobram interpretação de cruzamentos, probabilidade genética, heredogramas e relação genótipo-fenótipo. Fique atento a problemas que envolvem herança ligada ao sexo e codominância.`,
    ...
    flashcards: [
      { front: 'O que é um gene?', back: 'Um trecho de DNA que codifica uma proteína ou regula uma função celular. É a unidade fundamental da hereditariedade.', difficulty: 'easy' },
      { front: 'Qual a diferença entre genótipo e fenótipo?', back: 'Genótipo é a composição genética (ex: Aa). Fenótipo é a característica observável (ex: olhos castanhos), resultado do genótipo + ambiente.', difficulty: 'easy' },
      { front: 'O que diz a 1ª Lei de Mendel?', back: 'Lei da Segregação dos Fatores: cada característica é determinada por um par de alelos que se separam durante a formação dos gametas, indo um para cada célula reprodutiva.', difficulty: 'medium' },
      { front: 'Um casal Aa x Aa: qual a probabilidade do filho ser "aa"?', back: '25% (1/4). O cruzamento gera: AA (25%), Aa (50%), aa (25%).', difficulty: 'medium' },
      { front: 'O que é herança ligada ao sexo?', back: 'Quando o gene está no cromossomo X. Exemplo: daltonismo e hemofilia. Homens (XY) manifestam com apenas um alelo recessivo; mulheres (XX) precisam de dois.', difficulty: 'hard' },
      { front: 'Qual a diferença entre dominância incompleta e codominância?', back: 'Dominância incompleta: heterozigoto tem fenótipo intermediário (ex: flor rosa de vermelho x branco). Codominância: ambos alelos se expressam simultaneamente (ex: sangue AB).', difficulty: 'hard' },
    ],
    practiceQuestions: [
      {
        question: 'Em uma espécie de planta, a cor vermelha da flor (V) é dominante sobre a cor branca (v). Se cruzarmos duas plantas heterozigotas (Vv x Vv), qual a proporção esperada de plantas com flores brancas na prole?',
        alternatives: [
        ...
        explanation: 'O cruzamento Vv x Vv resulta em: VV (25%), Vv (50%), vv (25%). Apenas os indivíduos vv (homozigotos recessivos) terão flores brancas = 25%.',
      },
      {
        question: 'O daltonismo é uma condição recessiva ligada ao cromossomo X. Uma mulher portadora (XᴰXᵈ) casa-se com um homem normal (XᴰY). Qual a probabilidade de terem um filho homem daltônico?',
        alternatives: [
        ...
        explanation: 'A mãe XᴰXᵈ pode passar Xᴰ ou Xᵈ. O pai passa Y para filhos homens. Logo: metade dos filhos homens será XᵈY (daltônico) e metade XᴰY (normal). Como metade dos filhos são homens, a chance geral é 1/4 = 25%.',
      },
      {
        ...
        alternatives: [
          ...
          { letter: 'B', text: 'Os cromossomos homólogos se separam aleatoriamente na meiose', isCorrect: true },
        ...
        explanation: 'A 2ª Lei de Mendel se aplica quando os genes estão em cromossomos diferentes. Na meiose I, os cromossomos homólogos se separam de forma independente e aleatória, gerando combinações variadas nos gametas.',
      },
    ],
    mindMap: {
      topic: 'Genética',
...
Pratique converter situações do cotidiano em figuras geométricas. Muitas questões trazem contextos como: plantas de casas, terrenos, embalagens ou esportes.`,
    ...
    flashcards: [
      { front: 'Qual a fórmula da área de um triângulo?', back: 'Área = (base × altura) / 2', difficulty: 'easy' },
      { front: 'Enuncie o Teorema de Pitágoras', back: 'Em um triângulo retângulo, o quadrado da hipotenusa é igual à soma dos quadrados dos catetos: a² = b² + c²', difficulty: 'easy' },
      { front: 'Qual a área de um círculo de raio 5 cm?', back: 'A = πr² = π × 25 = 25π ≈ 78,54 cm²', difficulty: 'medium' },
      { front: 'Quando dois triângulos são semelhantes?', back: 'Quando têm todos os ângulos correspondentes iguais (AA). Nesse caso, os lados correspondentes são proporcionais.', difficulty: 'medium' },
      { front: 'Qual a área de um trapézio?', back: 'A = [(Base maior + Base menor) × altura] / 2', difficulty: 'medium' },
      { front: 'Um triângulo retângulo tem catetos 3 e 4. Qual a hipotenusa?', back: 'h² = 3² + 4² = 9 + 16 = 25 → h = 5', difficulty: 'easy' },
    ],
    practiceQuestions: [
      {
        question: 'Um terreno retangular tem 30 m de comprimento e 20 m de largura. Deseja-se construir um jardim circular de raio 5 m no centro do terreno. Qual a área restante do terreno?',
        alternatives: [
        ...
        explanation: 'Área do terreno = 30 × 20 = 600 m². Área do jardim circular = πr² = π × 25 = 25π m². Área restante = 600 - 25π m².',
      },
      {
        question: 'Uma escada de 10 m está apoiada em uma parede, com o pé a 6 m da base da parede. A que altura da parede a escada alcança?',
        alternatives: [
        ...
        explanation: 'Pelo Teorema de Pitágoras: 10² = 6² + h² → 100 = 36 + h² → h² = 64 → h = 8 m.',
      },
      {
        question: 'Dois triângulos semelhantes têm lados na razão 2:3. Se a área do menor é 20 cm², qual a área do maior?',
        alternatives: [
        ...
        explanation: 'A razão das áreas é o quadrado da razão dos lados: (3/2)² = 9/4. Área do maior = 20 × 9/4 = 45 cm².',
      },
    ],
    mindMap: {
...
export async function getMockStudyPackage(areaKey: string, topicoValue: string): Promise<StudyPackage> {
  ...
  return {
    ...
    flashcards: [
      { front: `O que é ${label}?`, back: `${label} é um tópico central da área. Na versão final, esta resposta será gerada pela IA.`, difficulty: 'easy' },
      { front: `Cite um exemplo de ${label} no cotidiano`, back: 'Exemplo contextualizado será gerado pela IA com base nos materiais da turma.', difficulty: 'medium' },
      { front: `Como ${label} aparece no ENEM?`, back: 'Geralmente em questões interdisciplinares com contextos práticos.', difficulty: 'medium' },
    ],
    practiceQuestions: [
      {
        ...
        explanation: 'Na versão final, a explicação será gerada pela IA com base nos materiais da turma.',
      },
    ],
    mindMap: {
      topic: label,
      root: {
        ...
        label,
        children: [
          { id: '2', label: 'Conceito 1', children: [{ id: '2a', label: 'Detalhe A' }, { id: '2b', label: 'Detalhe B' }] },
          { id: '3', label: 'Conceito 2', children: [{ id: '3a', label: 'Detalhe C' }, { id: '3b', label: 'Detalhe D' }] },
          { id: '4', label: 'Aplicações', children: [{ id: '4a', label: 'ENEM' }, { id: '4b', label: 'Cotidiano' }] },
        ],
      },
    },
  }
