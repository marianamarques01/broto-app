...
export function Settings() {
  ...
  const [prevPetNome, setPrevPetNome] = useState(pet?.nome)
  if (pet?.nome && pet.nome !== prevPetNome) {
    setPrevPetNome(pet.nome)
    setBrotoNome(pet.nome)
  }
  ...
  async function handleResetPracticeHistory() {
    ...
    try {
      ...
      setFormError(
        e instanceof Error
          ? e.message
          : 'Não foi possível zerar o histórico. Tenta de novo mais tarde.',
      )
    } finally {
    ...
    <div>
      ...
      <div className="broto-main-inner broto-main-inner--settings">
        <div className="broto-settings-page">
                ...
                <div className="broto-settings__hero-row">
                  ...
                  <div className="broto-settings__hero-copy">
                    ...
                    <p className="broto-settings__lede">
                      Nome, rotina, turma, mascote e tema. Use os atalhos ao lado (ou abaixo no
                      celular) para pular de seção. O que você salvar fica na sua conta.
                    </p>
                  </div>
                </div>
              </header>
              ...
              <div className="broto-settings__group" id="settings-section-conta">
                ...
                >
                  <div className="broto-settings__section-head">
                    <div>
                      <h2
                        className="broto-settings__section-title"
                        id={`${idPrefix}-section-perfil`}
                      >
                        Perfil
                      </h2>
                      <p className="broto-settings__section-desc">
                        Como você aparece no app, tempo disponível para estudo e dados da conta
                        (somente leitura).
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="broto-settings__grid">
                        ...
                        <div className="broto-settings__field">
                          <label className="broto-settings__label" htmlFor={`${idPrefix}-horas`}>
                            <BookOpen
                              size={14}
                              className="broto-settings__label-icon"
                              aria-hidden
                            />
                      ...
                      <div className="broto-settings__grid">
                        <div className="broto-settings__field">
                          ...
                          <p className="broto-settings__hint">
                            Vinculado ao login. Não é editável aqui.
                          </p>
                        </div>
                        ...
                        <div className="broto-settings__field">
                          ...
                          <p className="broto-settings__hint">
                            Definida no onboarding. Em breve: editar aqui.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                >
                  <div className="broto-settings__section-head">
                    <div>
                      ...
                      <p className="broto-settings__section-desc">
                        Abra de novo o tour em tela cheia com os principais blocos do Broto
                        (integração entre rotina, questões, simulado e Broto).
                      </p>
                    </div>
                  </div>
                  <div className="broto-settings__class-actions">
              ...
              <div className="broto-settings__group" id="settings-section-dados">
                ...
                >
                  ...
                  <ul className="broto-settings__action-list">
                    <li className="broto-settings__action-item">
                      <div className="broto-settings__action-copy">
                        ...
                        <p className="broto-settings__action-desc">
                          Remove respostas e desempenho por tópico no servidor, e zera contagens
                          locais do dia. XP e nível do Broto não mudam.
                        </p>
                      </div>
                      <button
                        type="button"
                    ...
                    <li
                      className="broto-settings__action-item"
                      aria-labelledby={`${idPrefix}-act-local`}
                    >
                      <div className="broto-settings__action-copy">
          ...
          <aside
            className="broto-settings__toc broto-settings__toc--rail"
