...
export function MockExamHistory() {
  ...
  return (
    <div className="broto-page broto-page--study">
      <TopBar title="Simulados anteriores" subtitle="Suas sessões de simulado ENEM" variant="study" />
        ...
        {!loading && !error && sessions.length === 0 ? (
          <div className="broto-mock-exam-empty">
            ...
            <p className="broto-muted" style={{ margin: '0 0 20px', fontSize: '0.88rem' }}>
              Você ainda não tem simulados registrados.
              <br />
              Faça um simulado para ver o histórico aqui.
            </p>
